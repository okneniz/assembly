...
func (i Sturh) ObjDump(_ disasm.ViewCtx) string {
	return fmt.Sprintf("sturh %s, %s", i.rt, i.lsText())
}

func (i Sturh) Encode(w io.Writer, pc uint64) (int64, error) {
	return i.lsWrite(w, pc, "sturh")
}

func (i Sturh) MarshalJSON() ([]byte, error) {
	return i.marshal(
		"sturh",
...
func decodeSturhOf(enc uint32, kind memKind, fp string) func(uint32, uint64) Instr {
