...
func (i Stur) ObjDump(_ disasm.ViewCtx) string {
	return fmt.Sprintf("stur %s, %s", i.rt, i.lsText())
}

func (i Stur) Encode(w io.Writer, pc uint64) (int64, error) {
	return i.lsWrite(w, pc, "stur")
}

func (i Stur) MarshalJSON() ([]byte, error) {
	return i.marshal(
		"stur",
...
func decodeSturOf(enc uint32, kind memKind, fp string) func(uint32, uint64) Instr {
