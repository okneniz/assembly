...
func (i Ldur) Encode(w io.Writer, pc uint64) (int64, error) {
	return i.lsWrite(w, pc, "ldur")
}

func (i Ldur) MarshalJSON() ([]byte, error) {
	return i.marshal(
		"ldur",
...
func decodeLdurOf(enc uint32, kind memKind, fp string) func(uint32, uint64) Instr {
