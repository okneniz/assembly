...
func (i FnmaddS) Encode(w io.Writer, pc uint64, o EncOpts) (int64, error) {
	rm := i.rm.val
...
func (i FnmaddS) MarshalJSON() ([]byte, error) {
	return i.marshalDTO("fnmadd.s", i.ObjDump(disasm.DefaultViewCtx()), "RV32F",
