...
func decodeFnmaddD(w uint32, addr uint64) Instr {
	return FnmaddD{
		base: newBase(addr, w),
...
func (i FnmaddD) Encode(w io.Writer, pc uint64, o EncOpts) (int64, error) {
	rm := i.rm.val
...
func (i FnmaddD) MarshalJSON() ([]byte, error) {
	return i.marshalDTO("fnmadd.d", i.ObjDump(disasm.DefaultViewCtx()), "RV64D",
