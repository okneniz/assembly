...
func decodeFmsubS(w uint32, addr uint64) Instr {
	return FmsubS{
		base: newBase(addr, w),
...
func (i FmsubS) Encode(w io.Writer, pc uint64, o EncOpts) (int64, error) {
	rm := i.rm.val
...
func (i FmsubS) MarshalJSON() ([]byte, error) {
	return i.marshalDTO("fmsub.s", i.ObjDump(disasm.DefaultViewCtx()), "RV32F",
