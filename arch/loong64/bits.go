...
// immediates split MSB-first (Sd5k16: [4:0] is imm[20:16], [25:10] is
// imm[15:0]).
//
// Range validation lives in the operand role types (NewImm12 and friends)
...
// d5k16Imm - the split offs21 field of beqz/bnez: [4:0] is imm[20:16],
// [25:10] is imm[15:0] (signed).
func d5k16Imm(w uint32) int64 {
	return signExtendN(uField(w, 0, 5)<<16|uField(w, 10, 16), 21)
}

// scatterD5k16 - the inverse of d5k16Imm: imm[20:16] to [4:0], imm[15:0]
// to [25:10] (v must be a validated 21-bit word offset).
func scatterD5k16(v int64) uint32 {
	return uint32(v>>16)&0x1f | uint32(v)&0xffff<<10
}

// d10k16Imm - the split offs26 field of b/bl: [9:0] is imm[25:16],
// [25:10] is imm[15:0] (signed).
func d10k16Imm(w uint32) int64 {
	return signExtendN(uField(w, 0, 10)<<16|uField(w, 10, 16), 26)
}

// scatterD10k16 - the inverse of d10k16Imm: imm[25:16] to [9:0],
// imm[15:0] to [25:10] (v must be a validated 26-bit word offset).
