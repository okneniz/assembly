...
// AmcasB - amcas.b rd, rk, rj (DJK, @orig_fmt=DKJ - the second assembly
...
// NewAmcasB - amcas.b rd, rk, rj (the operand order the assembler writes).
func NewAmcasB(rd, rk, rj Reg) Instr {
	return AmcasB{
		rd: rd.Num(),
		rk: rk.Num(),
		rj: rj.Num(),
