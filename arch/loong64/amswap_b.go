...
// AmswapB - amswap.b rd, rk, rj (DJK, @orig_fmt=DKJ - the second assembly
...
// NewAmswapB - amswap.b rd, rk, rj (the operand order the assembler writes).
func NewAmswapB(rd, rk, rj Reg) Instr {
	return AmswapB{
		rd: rd.Num(),
		rk: rk.Num(),
		rj: rj.Num(),
