...
// AmcasDbD - amcas_db.d rd, rk, rj (DJK, @orig_fmt=DKJ - the second assembly
...
// NewAmcasDbD - amcas_db.d rd, rk, rj (the operand order the assembler writes).
func NewAmcasDbD(rd, rk, rj Reg) Instr {
	return AmcasDbD{
		rd: rd.Num(),
		rk: rk.Num(),
		rj: rj.Num(),
